...
def SceneInitiliazer():
    ...
    obj = Object(parser.vertices, faces=parser.faces, normals=parser.normals, uv=parser.uv, face_normals=parser.faces_normal,
...
def display():
    ...
    scene.draw_scene(camera.get_view_matrix().to_numpy_array(), Matrix4.getProjMatrix(camNear, camFar, camAspect, camFov)
